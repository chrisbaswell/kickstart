...
>
    ...
    >
        <div class="space-y-2">
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        @class([
                            'tracking-normal whitespace-pre-wrap overflow-y-hidden font-mono block absolute bg-transparent top-0 text-sm left-0 block z-1 w-full h-full min-h-full resize-none transition duration-75 rounded-lg focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600',
            ...
            <div class="block w-full h-full min-h-full px-3 py-2 bg-white border border-base-300 rounded-lg focus:border-primary-300" x-show="tab === 'preview'" style="min-height: 150px;">
