                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            @if ($hasToolbarButton('edit'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-base-400': tab !== 'edit' }"
                            ...
                            @if ($hasToolbarButton('preview'))
                                <button
                                    ...
                                    x-bind:class="{ 'text-base-400': tab !== 'preview' }"
                                    class="text-sm hover:underline"
                                >
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        @class([
                            'tracking-normal whitespace-pre-wrap overflow-y-hidden font-mono block absolute bg-transparent top-0 text-sm left-0 block z-1 w-full h-full min-h-full resize-none transition duration-75 rounded-lg shadow-sm focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600',
                ...
                <div
                    ...
                    class="w-full h-full rounded-lg px-3 py-2 border border-transparent font-mono tracking-normal bg-white text-sm text-base-900 break-words whitespace-pre-wrap"
                ></div>
            </div>

            <div class="block w-full h-full min-h-full px-3 py-2 bg-white border border-base-300 rounded-lg shadow-sm focus:border-primary-300" x-show="tab === 'preview'" style="min-height: 150px;">
