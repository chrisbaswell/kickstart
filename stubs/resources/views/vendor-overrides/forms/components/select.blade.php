    ...
    @else
        ...
        >
            <div
                ...
                @endunless
                @class([
                    'text-base-900 relative flex items-center border w-full h-10 pl-3 px-10 overflow-hidden transition duration-75 rounded-lg outline-none appearance-none focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-inset focus-within:ring-primary-500',
                    'border-base-300' => ! $errors->has($getStatePath()),
                    'border-danger-500 ring-danger-500' => $errors->has($getStatePath()),
                    'bg-white' => ! $isDisabled(),
                    'bg-base-100' => $isDisabled()
            ...
            @unless($isDisabled())
                <div
                    ...
                    tabindex="-1"
                    x-cloak
                    class="absolute z-10 w-full my-1 bg-white border border-base-300 rounded-lg shadow-sm focus:outline-none"
                >
                    <ul
