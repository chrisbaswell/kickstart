...
>
    ...
    >
        <div
            ...
            @class([
                'block w-full transition duration-75 divide-y rounded-lg border overflow-hidden focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-primary-600',
        ...
        >
            ...
            <div
                x-show="state.length"
                class="overflow-hidden rtl:space-x-reverse relative w-full px-1 py-1 bg-white border-b-lg"
            >
                <div class="flex flex-wrap gap-1">
                    <template class="inline" x-for="tag in state" x-bind:key="tag">
                        <button
                            ...
                            type="button"
                            @class([
                                'inline-flex items-center justify-center h-6 px-2 my-1 text-sm font-medium tracking-tight text-primary-700 rounded-full bg-primary-600/10 space-x-1',
