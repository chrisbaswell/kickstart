...
<li>
    <button
        ...
        {{ $attributes->class([
            ...
            'hover:bg-base-500/5 focus:bg-primary-600/10 focus:ring-2 focus:ring-primary-600' => (! $active) && (! $disabled) && (! $separator),
            ...
            'z-10 focus:underline bg-primary-600/10 ring-2 ring-primary-600' => $active,
