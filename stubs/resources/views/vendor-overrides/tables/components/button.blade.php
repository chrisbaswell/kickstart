...
@php
    $buttonClasses = [
        ...
        'text-base-800 bg-white border border-base-300 hover:bg-base-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600' => $color === 'secondary',
